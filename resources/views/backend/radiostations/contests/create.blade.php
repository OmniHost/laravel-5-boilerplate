...
@section('content')
{{ html()->form('POST', route('admin.contests.store', $stationId))->class('form-horizontal')->open() }}
<div class="card">
	<div class="card-body">
		<div class="row">
			<div class="col-sm-5">
				<h4 class="card-title mb-0">
					Radio Contests
					<small class="text-muted">Add Contest</small>
				</h4>
			</div>
			<!--col-->
		</div>
		...
		<div class="row mt-4">
			<div class="col">
				...
				<div class="form-group row ">
					...
					<div class="col-md-10 dropzoneimagecontainer">
						<input type="hidden" name="upload_id" id="upload_id" value="" />
						<input type="text" class="form-control" id="upload_id_filename" disabled value="" />
				...
				<div class="form-group row ">
					...
					<div class="col-md-3 col-sm-6 col-xs-12 dropzoneimagecontainer">
						...
						<input data-for="id" type="hidden" name="shareimage1" id="shareimage1_id" value="" />
						<input data-for="name" type="text" class="form-control" id=shareimage1_filename" disabled
							value="" />
					...
					<div class="col-md-3 col-sm-6 col-xs-12 dropzoneimagecontainer">
						...
						<input data-for="id" type="hidden" name="shareimage2" id="shareimage2_id" value="" />
						<input data-for="name" type="text" class="form-control" id=shareimage2_filename" disabled
							value="" />
					...
					<div class="col-md-3 col-sm-6 col-xs-12 dropzoneimagecontainer">
						...
						<input data-for="id" type="hidden" name="shareimage3" id="shareimage3_id" value="" />
						<input data-for="name" type="text" class="form-control" id=shareimage3_filename" disabled
							value="" />
					...
					<div class="col-md-3 col-sm-6 col-xs-12 dropzoneimagecontainer">
						...
						<input data-for="id" type="hidden" name="shareimage4" id="shareimage4_id" value="" />
						<input data-for="name" type="text" class="form-control" id=shareimage4_filename" disabled
							value="" />
